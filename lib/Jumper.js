(function () {
  ...
  Jumper.prototype.isBouncing = function(trampoline) {
    ...
    return (this.position.y + realHeight > trampoline.pos[1] + 10)  // && 
      // (this.position.x < this.game.trampoline.pos[0] + this.game.trampoline.width || 
      //   this.position.x > this.game.trampoline.pos[0]) ; //&& (this.position.y <= trampoline.pos[1] - 1);
  };
  ...
  Jumper.prototype.move = function() {
    ...
    if (this.position.x > this.game.trampoline.pos[0] + this.game.trampoline.width || 
            this.position.x < this.game.trampoline.pos[0]) {
  ...
  Jumper.prototype.fallOver = function(first_argument) {
